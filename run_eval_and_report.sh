#!/bin/bash
echo "=== BẮT ĐẦU CHẠY SÀNG LỌC BOT, HUẤN LUYỆN ROUTER VÀ XUẤT BÁO CÁO ==="

# Đảm bảo sử dụng đúng môi trường ảo Python
...
$PYTHON_CMD src/EarnHFT_framwork/tool/run_validation.py
...
# -------------------------------------------------------------
# PHẦN 2: Xuất Báo Cáo và Vẽ Đồ Thị (Đã bỏ các file theo yêu cầu)
# -------------------------------------------------------------
